// 发布身份一致性：正式版统一为 1.0.0，锁定四处版本声明，界面不得出现 0.1.0。
...
describe('发布版本一致性（1.0.0）', () => {
  ...
  it('Cargo.lock 中 keym 自身条目为 1.0.0', () => {
